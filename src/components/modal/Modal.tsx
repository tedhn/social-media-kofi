...
const Modal: FC<PropTypes> = ({ render, closeModal }) => {
	...
	return (
		<div className='fixed w-full h-full bg-black/50 top-0 left-0 overflow-hidden'>
			<div className='relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/2 bg-white p-8 flex flex-col justify-between rounded-md items-center gap-8'>
				{render(
					image,
					caption,
					setImage,
